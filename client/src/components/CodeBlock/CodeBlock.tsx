  ...
  useAsyncEffect(async () => {
    if (lang) {
      try {
        ...
        // Tutor responses stream one character at a time, so a fenced code
        // language can briefly be incomplete or unsupported. Keep rendering
        // the code as plain text until the language becomes valid.
        setHtml("");
      }
    } else {
      setHtml("");
